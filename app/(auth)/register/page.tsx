  ...
  if (success) {
    return (
      <div style={{ width: '100%', maxWidth: '400px', animation: 'fade-up 0.4s ease both' }}>
        ...
        >
          <CheckCircle2 size={32} style={{ color: 'var(--live)', margin: '0 auto 16px' }} />
          <h2
            className="font-display font-bold uppercase"
            style={{ fontSize: '14px', letterSpacing: '0.08em', color: 'var(--text-1)', marginBottom: '8px' }}
          >
            Check your email
          </h2>
          <p className="font-body" style={{ fontSize: '12px', color: 'var(--text-2)', marginBottom: '20px', lineHeight: 1.6 }}>
          ...
          <Link
            href="/login"
            className="font-display font-bold uppercase"
            style={{ fontSize: '9px', letterSpacing: '0.18em', color: 'var(--accent)', textDecoration: 'none' }}
          >
            ← Back to sign in
          </Link>
        </div>
      ...
      >
        ...
        <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          {error && (
            <div
              className="font-body"
              style={{ fontSize: '11px', color: 'var(--danger)', border: '1px solid var(--danger)', padding: '9px 12px' }}
            >
              {error}
            </div>
          )}
